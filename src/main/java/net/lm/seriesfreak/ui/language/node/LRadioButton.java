 ...
 * @author Luke Melaia
 */
public class LRadioButton extends RadioButton implements LanguageComponent<LRadioButton>{
    ...
    @Override
    public LRadioButton setTextKey(String text) {
        textKey = text;
    ...
    @Override
    public LRadioButton setTooltipKey(String text) {
    ...
    @Override
    public LRadioButton setPromptKey(String key) {
